...
with open('src/ingestion/ohlcv.py', 'w') as f:
    f.write('\
\\)" >> build_ohlcv.py && echo "    f.write(chr(10) + OHLCV
Data
Ingestion
Module + chr(10) + chr(10))" >> build_ohlcv.py && echo "    f.write(Supports
multiple
data
providers
with
failover: + chr(10))" >> build_ohlcv.py && echo "    f.write(Polygon.io
primary + chr(10))" >> build_ohlcv.py && echo "    f.write(Yahoo
Finance
fallback + chr(10))" >> build_ohlcv.py && echo "    f.write(Alpha
Vantage
fallback + chr(10))" >> build_ohlcv.py && echo "    f.write(\\\' + chr(10) + chr(10))
